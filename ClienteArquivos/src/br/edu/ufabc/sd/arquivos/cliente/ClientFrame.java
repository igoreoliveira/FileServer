 ...
 */
package br.edu.ufabc.sd.arquivos.cliente;

import br.edu.ufabc.sd.arquivos.*;
...
public class ClientFrame extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            //quando tiver controller, por keep alive
            ObjectOutputStream output = new ObjectOutputStream(cli.getOutputStream());
            
            Arquivo file = new Arquivo();
            file.setNome(jTextField3.getText());
            
            Requisicao req = new Requisicao();
            req.setMsg(Requisicao.READ_FILE);
            req.setFile(file);
            ...
            if (rep.getMsg() == Resposta.READ_FILE_NOT_OK){
                JOptionPane.showMessageDialog(this,"Erro ao ler arquivo");
            }
            else{
                JOptionPane.showMessageDialog(this, "Arquivo lido");
                jTextField2.setText(rep.getFile().getConteudo());
            }
